 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Sun Apr 10 17:01:14 2005
 * 
 *
 */


#define S_FUNCTION_NAME builderA
...
extern void builderA_Outputs_wrapper(const real_T *u0,
                          real_T *y0,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    builderA_Outputs_wrapper(u0, y0, y_width, u_width);
}
