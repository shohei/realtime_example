 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Sun Apr 10 17:50:46 2005
 * 
 *
 */


#define S_FUNCTION_NAME builderD
...
extern void builderD_Outputs_wrapper(const real_T *u0,
                          real_T *y0 ,
			   const real_T *xC,
                          const real_T  *m, const int_T p_width0);
extern void builderD_Derivatives_wrapper(const real_T *u0,
                          const real_T *y0,
                          real_T *dx ,
                           real_T *xC, 
                          const real_T  *m, const int_T  p_width0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T  *m  = mxGetData(PARAM_DEF0(S));

    builderD_Outputs_wrapper(u0, y0, xC, m, p_width0);
}
...
/* Function: mdlDerivatives =================================================
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    builderD_Derivatives_wrapper(u0, y0,dx, xC, m, p_width0);
}
