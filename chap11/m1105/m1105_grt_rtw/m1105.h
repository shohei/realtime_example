 ...
 */
#ifndef _RTW_HEADER_m1105_h_
#define _RTW_HEADER_m1105_h_
...
#define m1105_rtModel                   rtModel_m1105

/* Block signals (auto storage) */
typedef struct _BlockIO_m1105 {
...
typedef struct D_Work_m1105_tag {
  struct {
    void *LoggedData;
...
typedef struct _ContinuousStates_m1105 {
  real_T Integrator1_CSTATE[3];         /* '<Root>/Integrator1' */
  real_T Integrator_CSTATE[3];          /* '<Root>/Integrator' */
} ContinuousStates_m1105;

/* State derivatives (auto storage) */
typedef struct _StateDerivatives_m1105 {
  real_T Integrator1_CSTATE[3];         /* '<Root>/Integrator1' */
  real_T Integrator_CSTATE[3];          /* '<Root>/Integrator' */
} StateDerivatives_m1105;

/* State disabled  */
typedef struct _StateDisabled_m1105 {
...
#define rtB                             m1105_B
#define BlockIO                         BlockIO_m1105
#define rtX                             m1105_X
#define ContinuousStates                ContinuousStates_m1105
#define rtP                             m1105_P
#define Parameters                      Parameters_m1105
#define rtDWork                         m1105_DWork
#define D_Work                          D_Work_m1105

/* Parameters (auto storage) */
struct _Parameters_m1105 {
...
extern Parameters_m1105 m1105_P;

/* Block signals (auto storage) */
extern BlockIO_m1105 m1105_B;

/* Continuous states (auto storage) */
extern ContinuousStates_m1105 m1105_X;

/* Block states (auto storage) */
extern D_Work_m1105 m1105_DWork;

/* Model entry point functions */

extern void m1105_initialize(boolean_T firstTime);
extern void m1105_output(int_T tid);
extern void m1105_update(int_T tid);
extern void m1105_terminate(void);

/* Real-time Model object */
extern rtModel_m1105 *m1105_M;
