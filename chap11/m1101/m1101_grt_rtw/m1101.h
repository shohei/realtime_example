 ...
 */
#ifndef _RTW_HEADER_m1101_h_
#define _RTW_HEADER_m1101_h_
...
#define m1101_rtModel                   rtModel_m1101

/* Block signals (auto storage) */
typedef struct _BlockIO_m1101 {
  real_T Gain;                          /* '<Root>/Gain' */
} BlockIO_m1101;

/* Block states (auto storage) for system: '<Root>' */
typedef struct D_Work_m1101_tag {
  struct {
    void *LoggedData;
...
#define rtB                             m1101_B
#define BlockIO                         BlockIO_m1101
#define rtXdot                          m1101_Xdot
#define StateDerivatives                StateDerivatives_m1101
#define tXdis                           m1101_Xdis
#define StateDisabled                   StateDisabled_m1101
#define rtP                             m1101_P
#define Parameters                      Parameters_m1101
#define rtDWork                         m1101_DWork
#define D_Work                          D_Work_m1101

/* Parameters (auto storage) */
struct _Parameters_m1101 {
...
extern Parameters_m1101 m1101_P;

/* Block signals (auto storage) */
extern BlockIO_m1101 m1101_B;

/* Block states (auto storage) */
extern D_Work_m1101 m1101_DWork;

/* Model entry point functions */

extern void m1101_initialize(boolean_T firstTime);
extern void m1101_output(int_T tid);
extern void m1101_update(int_T tid);
extern void m1101_terminate(void);

/* Real-time Model object */
extern rtModel_m1101 *m1101_M;
