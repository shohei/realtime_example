 ...
 */
#ifndef _RTW_HEADER_m1103_h_
#define _RTW_HEADER_m1103_h_
...
#define m1103_rtModel                   rtModel_m1103

/* Block signals (auto storage) */
typedef struct _BlockIO_m1103 {
  real_T Gain;                          /* '<Root>/Gain' */
} BlockIO_m1103;

/* Block states (auto storage) for system: '<Root>' */
typedef struct D_Work_m1103_tag {
  struct {
    void *LoggedData;
...
#define rtB                             m1103_B
#define BlockIO                         BlockIO_m1103
#define rtXdot                          m1103_Xdot
#define StateDerivatives                StateDerivatives_m1103
#define tXdis                           m1103_Xdis
#define StateDisabled                   StateDisabled_m1103
#define rtP                             m1103_P
#define Parameters                      Parameters_m1103
#define rtDWork                         m1103_DWork
#define D_Work                          D_Work_m1103

/* Parameters (auto storage) */
struct _Parameters_m1103 {
  ...
  real_T SineWave_Phase;                /* Expression: 0
                                         * '<Root>/Sine Wave'
                                         */
  real_T Gain_Gain;                     /* Expression: g
                                         * '<Root>/Gain'
                                         */
};

/* Real-time Model Data Structure */
struct _rtModel_m1103_Tag {
  const char *path;
...
extern Parameters_m1103 m1103_P;

/* Block signals (auto storage) */
extern BlockIO_m1103 m1103_B;

/* Block states (auto storage) */
extern D_Work_m1103 m1103_DWork;

/* Model entry point functions */

extern void m1103_initialize(boolean_T firstTime);
extern void m1103_output(int_T tid);
extern void m1103_update(int_T tid);
extern void m1103_terminate(void);

/* Real-time Model object */
extern rtModel_m1103 *m1103_M;
