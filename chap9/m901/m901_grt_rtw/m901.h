 ...
 */
#ifndef _RTW_HEADER_m901_h_
#define _RTW_HEADER_m901_h_
...
#define m901_rtModel                    rtModel_m901

/* Block signals (auto storage) */
typedef struct _BlockIO_m901 {
  real_T Gain;                          /* '<Root>/Gain' */
} BlockIO_m901;

/* Block states (auto storage) for system: '<Root>' */
typedef struct D_Work_m901_tag {
  struct {
    void *LoggedData;
...
#define rtB                             m901_B
#define BlockIO                         BlockIO_m901
#define rtXdot                          m901_Xdot
#define StateDerivatives                StateDerivatives_m901
#define tXdis                           m901_Xdis
#define StateDisabled                   StateDisabled_m901
#define rtP                             m901_P
#define Parameters                      Parameters_m901
#define rtDWork                         m901_DWork
#define D_Work                          D_Work_m901

/* Parameters (auto storage) */
struct _Parameters_m901 {
...
extern Parameters_m901 m901_P;

/* Block signals (auto storage) */
extern BlockIO_m901 m901_B;

/* Block states (auto storage) */
extern D_Work_m901 m901_DWork;

/* Real-time Model object */
extern rtModel_m901 *m901_M;
