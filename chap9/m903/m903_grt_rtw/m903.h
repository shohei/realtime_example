 ...
 */
#ifndef _RTW_HEADER_m903_h_
#define _RTW_HEADER_m903_h_
...
#define m903_rtModel                    rtModel_m903

/* Block signals (auto storage) */
typedef struct _BlockIO_m903 {
  real_T SineWave;                      /* '<Root>/Sine Wave' */
} BlockIO_m903;

/* Continuous states (auto storage) */
typedef struct _ContinuousStates_m903 {
  real_T Integrator_CSTATE;             /* '<Root>/Integrator' */
} ContinuousStates_m903;

/* State derivatives (auto storage) */
typedef struct _StateDerivatives_m903 {
  real_T Integrator_CSTATE;             /* '<Root>/Integrator' */
} StateDerivatives_m903;

/* State disabled  */
typedef struct _StateDisabled_m903 {
...
typedef struct _ExternalOutputs_m903_tag {
  real_T Out1;                          /* '<Root>/Out1' */
} ExternalOutputs_m903;

/* Backward compatible GRT Identifiers */
#define rtB                             m903_B
#define BlockIO                         BlockIO_m903
#define rtX                             m903_X
#define ContinuousStates                ContinuousStates_m903
#define rtY                             m903_Y
#define ExternalOutputs                 ExternalOutputs_m903
#define rtP                             m903_P
#define Parameters                      Parameters_m903

/* Parameters (auto storage) */
struct _Parameters_m903 {
...
extern Parameters_m903 m903_P;

/* Block signals (auto storage) */
extern BlockIO_m903 m903_B;

/* Continuous states (auto storage) */
extern ContinuousStates_m903 m903_X;

/* External outputs (root outports fed by signals with auto storage) */
extern ExternalOutputs_m903 m903_Y;

/* Model entry point functions */

extern void m903_initialize(boolean_T firstTime);
extern void m903_output(int_T tid);
extern void m903_update(int_T tid);
extern void m903_terminate(void);

/* Real-time Model object */
extern rtModel_m903 *m903_M;
