 ...
 */
#ifndef _RTW_HEADER_m904_h_
#define _RTW_HEADER_m904_h_
...
#define m904_rtModel                    rtModel_m904

/* Block signals (auto storage) */
typedef struct _BlockIO_m904 {
...
typedef struct D_Work_m904_tag {
  struct {
    void *LoggedData;
...
typedef struct _ContinuousStates_m904 {
  real_T Integrator1_CSTATE[3];         /* '<Root>/Integrator1' */
  real_T Integrator_CSTATE[3];          /* '<Root>/Integrator' */
} ContinuousStates_m904;

/* State derivatives (auto storage) */
typedef struct _StateDerivatives_m904 {
  real_T Integrator1_CSTATE[3];         /* '<Root>/Integrator1' */
  real_T Integrator_CSTATE[3];          /* '<Root>/Integrator' */
} StateDerivatives_m904;

/* State disabled  */
typedef struct _StateDisabled_m904 {
...
#define rtB                             m904_B
#define BlockIO                         BlockIO_m904
#define rtX                             m904_X
#define ContinuousStates                ContinuousStates_m904
#define rtP                             m904_P
#define Parameters                      Parameters_m904
#define rtDWork                         m904_DWork
#define D_Work                          D_Work_m904

/* Parameters (auto storage) */
struct _Parameters_m904 {
...
extern Parameters_m904 m904_P;

/* Block signals (auto storage) */
extern BlockIO_m904 m904_B;

/* Continuous states (auto storage) */
extern ContinuousStates_m904 m904_X;

/* Block states (auto storage) */
extern D_Work_m904 m904_DWork;

/* Model entry point functions */

extern void m904_initialize(boolean_T firstTime);
extern void m904_output(int_T tid);
extern void m904_update(int_T tid);
extern void m904_terminate(void);

/* Real-time Model object */
extern rtModel_m904 *m904_M;
