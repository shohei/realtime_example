...
MODEL                = m1005
MODULES              = m1005_data.c rt_nonfinite.c 
MAKEFILE             = m1005.mk
...
ADD_INCLUDES = \
	-I$(MATLAB_ROOT)\work\chapt10\m1005 \
	-I$(MATLAB_ROOT)\work\chapt10\m1005\m1005_grt_rtw \
...
%.obj : $(MATLAB_ROOT)\work\chapt10\m1005/%.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
