...
MODEL                = m1002
MODULES              = m1002_data.c rt_nonfinite.c 
MAKEFILE             = m1002.mk
...
ADD_INCLUDES = \
	-I$(MATLAB_ROOT)\work\chapt10\m1002 \
	-I$(MATLAB_ROOT)\work\chapt10\m1002\m1002_grt_rtw \
...
%.obj : $(MATLAB_ROOT)\work\chapt10\m1002/%.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
