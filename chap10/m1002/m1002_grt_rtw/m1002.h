 ...
 */
#ifndef _RTW_HEADER_m1002_h_
#define _RTW_HEADER_m1002_h_
...
#define m1002_rtModel                   rtModel_m1002

/* Block signals (auto storage) */
typedef struct _BlockIO_m1002 {
  real_T SineWave;                      /* '<Root>/Sine Wave' */
  real_T SFunctionBuilder;              /* '<Root>/S-Function Builder' */
} BlockIO_m1002;

/* External outputs (root outports fed by signals with auto storage) */
typedef struct _ExternalOutputs_m1002_tag {
  real_T Out1;                          /* '<Root>/Out1' */
} ExternalOutputs_m1002;

/* Backward compatible GRT Identifiers */
#define rtB                             m1002_B
#define BlockIO                         BlockIO_m1002
#define rtXdot                          m1002_Xdot
#define StateDerivatives                StateDerivatives_m1002
#define tXdis                           m1002_Xdis
#define StateDisabled                   StateDisabled_m1002
#define rtY                             m1002_Y
#define ExternalOutputs                 ExternalOutputs_m1002
#define rtP                             m1002_P
#define Parameters                      Parameters_m1002

/* Parameters (auto storage) */
struct _Parameters_m1002 {
...
extern Parameters_m1002 m1002_P;

/* Block signals (auto storage) */
extern BlockIO_m1002 m1002_B;

/* External outputs (root outports fed by signals with auto storage) */
extern ExternalOutputs_m1002 m1002_Y;

/* Real-time Model object */
extern rtModel_m1002 *m1002_M;
