 ...
 */
#ifndef _RTW_HEADER_m1001_h_
#define _RTW_HEADER_m1001_h_
...
#define m1001_rtModel                   rtModel_m1001

/* Block signals (auto storage) */
typedef struct _BlockIO_m1001 {
  real_T SineWave;                      /* '<Root>/Sine Wave' */
  real_T SFunctionBuilder;              /* '<Root>/S-Function Builder' */
} BlockIO_m1001;

/* External outputs (root outports fed by signals with auto storage) */
typedef struct _ExternalOutputs_m1001_tag {
  real_T Out1;                          /* '<Root>/Out1' */
} ExternalOutputs_m1001;

/* Backward compatible GRT Identifiers */
#define rtB                             m1001_B
#define BlockIO                         BlockIO_m1001
#define rtXdot                          m1001_Xdot
#define StateDerivatives                StateDerivatives_m1001
#define tXdis                           m1001_Xdis
#define StateDisabled                   StateDisabled_m1001
#define rtY                             m1001_Y
#define ExternalOutputs                 ExternalOutputs_m1001
#define rtP                             m1001_P
#define Parameters                      Parameters_m1001

/* Parameters (auto storage) */
struct _Parameters_m1001 {
...
extern Parameters_m1001 m1001_P;

/* Block signals (auto storage) */
extern BlockIO_m1001 m1001_B;

/* External outputs (root outports fed by signals with auto storage) */
extern ExternalOutputs_m1001 m1001_Y;

/* Real-time Model object */
extern rtModel_m1001 *m1001_M;
