...
MODEL                = m1001
MODULES              = m1001_data.c rt_nonfinite.c 
MAKEFILE             = m1001.mk
...
ADD_INCLUDES = \
	-I$(MATLAB_ROOT)\work\chapt10\m1001 \
	-I$(MATLAB_ROOT)\work\chapt10\m1001\m1001_grt_rtw \
...
%.obj : $(MATLAB_ROOT)\work\chapt10\m1001/%.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
